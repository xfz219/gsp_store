...
win.window({title:_25f,noheader:(_25f?false:true),width:300,height:"auto",modal:true,closable:$.messager.defaults.closableFlag,collapsible:false,minimizable:false,maximizable:false,resizable:false,onClose:function(){
setTimeout(function(){
win.window("destroy");
},100);
}});
...
$.messager.defaults={ok:"Ok",cancel:"Cancel",closableFlag:true};
})(jQuery);
(function($){
function _271(_272){
