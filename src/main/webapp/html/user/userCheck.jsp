...
<div id="usercheckDialog">
    <table>
        ...
        <tr>
            ...
            <td width="120">
                <input id="checkUserMobile" readonly="readonly" type="text" name="mobile" class="easyui-validatebox">
        </tr>
        <tr>
            ...
            <td width="120">
                <input readonly="readonly" id="checkUserProvince" type="text" name="userProvince"
        ...
        <tr id="defect_data1" style="display:none">
            ...
            <td width="120">
                <input readonly="readonly" id="checkUserIsSettle" type="text" name="isSettle"
                       class="easyui-validatebox">
            <td width="80" style="text-align:right">进件产品：</td>
            <td width="120">
                <input readonly="readonly" id="checkUserProductName" type="text" name="productName"
                       class="easyui-validatebox">
        </tr>
        <tr id="defect_data2" style="display:none">
            <td width="80" style="text-align: right">结清日期：</td>
            <td width="120">
                <input readonly="readonly" id="checkUserSettleTime" type="text" name="settleTime"
